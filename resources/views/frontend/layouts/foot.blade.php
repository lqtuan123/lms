  ...
  ==========================*/
     ...
     (function($) {
         ...
         if ($(window).width() < 1199) {
             $('.header-2 .navbar .sidebar-bar, .header-2 .navbar .sidebar-back, .header-2 .mobile-search img').on(
                 'click',
                 function() {
             ...
             $('.layout3-menu .mobile-search .ti-search, .header-2 .mobile-search .ti-search').on('click',
         function() {
                 $('.layout3-menu #main-nav .toggle-nav, .header-2 #main-nav .toggle-nav').css('z-index',
                     '1');
             });
         }
         ...
         $(".tabs li a").on('click', function() {
             ...
             $('#' + currunt_href).show();
             $(this).parent().parent().parent().find(".tab-content").not('#' + currunt_href).css("display",
                 "none");
             $(".product-4").slick({
                 arrows: true,
                 dots: false,
         ...
         $(".tabs li a").on('click', function() {
             ...
             var currunt_href = $(this).attr("href");
             $('#' + currunt_href).show();
             $(this).parent().parent().parent().parent().find(".tab-content").not('#' + currunt_href).css(
                 "display", "none");
             $(".product-3").slick({
                 arrows: true,
                 dots: false,
             ...
             $.ajax({
                 ...
                 success: function(response) {
                     ...
                     while (dem < 5) {
                         ...
                         innerhtml +=
                             '<li> <div class="media"> <a href="#"><img alt="" class="me-3" ' +
                             '    src="' + (imageurls.length > 0 ? imageurls[0] : "") +
                             '"></a>  <div class="media-body">  <a href="#">  <h4>' + pp.title +
                             '</h4> ' +
                     ...
                     innerhtml += ' <li>  <div class="total">  <h5>Tổng : <span>' +
                         ...
                         '   </div>  </li>  <li>  <div class="buttons"><a href="' + '' +
                         '" class="view-cart">' +
                         'xem giỏ hàng</a> <a href="' + '' +
                         '" class="checkout">Mua hàng</a></div>  </li>';
