            ...
            <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                <div class="w-56 relative text-slate-500">
                    <form action="{{ route('admin.user.search') }}" method = "get">
                        <!-- @csrf -->
                        <input type="text" name="datasearch" value="{{ $searchdata }}"
                        ...
                        <tr class="intro-x">
                            <td>
                                <a href="javascript:void(0)" data-id="{{ $item->id }}"
                                    class="font-medium whitespace-nowrap showdata">{{ $item->full_name }}</a>
                            </td>
                                ...
                                <div class="flex">
                                    ...
                                    foreach ($photos as $photo) {
                                        echo '<div class="w-10 h-10 image-fit zoom-in">
                                                                                                                                                                                                <img class="tooltip rounded-full"  src="' .
                                            $photo .
                                            '"/>
                                                                                                                                                                                            </div>';
                                    }
                            ...
                            <td class="text-center">
                                <input type="checkbox" data-toggle="switchbutton" data-onlabel="active"
                                    ...
                                    name="toogle" value="{{ $item->id }}" data-style="ios">
                            </td>

                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <a href="{{ route('admin.user.edit', $item->id) }}" class="flex items-center mr-3"
                                        href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit
                                    </a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h2 class="font-medium text-base mr-auto"> &nbsp; Thông tin người dùng </h2>
                ...
                <div class="modal-body p-5 text-center">
                    ...
                    <div class="grid grid-cols-12 gap-6 mt-5">
                        <div class="intro-y col-span-12 lg:col-span-6 text-left">
                            <span class="form-label font-medium"> Tên: </span> <br /> <span id='md_full_name'>name</span>
                            <br /><br />
                            <span class="form-label font-medium"> Email: </span> <br /><span id='md_email'>email</span>
                            <br /><br />
                            <span class="form-label font-medium"> Vai trò: </span> <br /><span id='md_role'>email</span>
                            <br /><br />

                        </div>
                        <div class="intro-y col-span-12 lg:col-span-6  text-left">
                            <span class="form-label font-medium"> Điện thoại: </span> <br /><span
                                id='md_phone'>phone</span> <br /><br />
                            <span class="form-label font-medium"> Địa chỉ: </span> <br /><span id='md_address'>dc</span>
                            <br /><br />
                            <span class="form-label font-medium"> Tình trạng: </span><br /> <span
                                class="py-1 px-2 rounded-full text-xs font-medium text-xs text-white"
                                id='md_status'>dc</span> <br /><br />
                        </div>
                    </div>
