...
@section('content')
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">
            Thêm chứng nhận hoàn thành khóa học
        </h2>
    </div>
    <div class="grid grid-cols-12 gap-12 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form method="post" action="{{route('admin.enrollcertificates.store')}}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="mt-3">
                        ...
                        <select id = "nguoicap_id" name="nguoicap_id" class="form-select mt-2">
                            @foreach ($teacher as $data)
                                <option value="{{ $data->id }}">{{ $data->mgv }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mt-3">
