...
class TSurveyController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($this->check_quyendangbai($page))
        {
            ...
            $datam['item_id']= $survey->id;
            $datam['item_code']= 'survey';
            $datam['page_id']= $data['item_id'];
            ...
            if($data['item_code']="page")
            {
                ...
                if($page)
                {
                    return redirect()->route('front.pagesurvey.index',$page->slug)->with('success', 'Survey đã được thêm thành công!');
                }
            }
        }
        else
