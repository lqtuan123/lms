...
class CFunctionController extends Controller
{
    ...
    public function cmdfunctionSearch(Request $request)
    {
        ...
        if($request->datasearch)
        {
            ...
            $breadcrumb = '
            <li class="breadcrumb-item"><a href="#">/</a></li>
            <li class="breadcrumb-item  " aria-current="page"><a href="'.route('admin.cmdfunction.index').'">cmdfunctions</a></li>
        ...
        {
            return redirect()->route('admin.cmdfunction.index')->with('success','Không có thông tin tìm kiếm!');
        }
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            return redirect()->route('admin.cmdfunction.index')->with('success','Tạo cmdfunction thành công!');
        }
        else
        {
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($cmdfunction)
        {
            ...
            if($status){
                return redirect()->route('admin.cmdfunction.index')->with('success','Cập nhật thành công');
            }
            else
            {
    ...
    public function destroy(string $id)
    {
        ...
        if($cmdfunction)
        {
            ...
            if($status){
                return redirect()->route('admin.cmdfunction.index')->with('success','Xóa cmdfunction thành công!');
            }
            else
            {
                return back()->with('error','Có lỗi xãy ra!');
